...
const months = ["Jan", "Feb", "mar", "June", "Apr", "May",]
// months.splice(months.length, 4, "Dec");
// console.log(months);

// Q2. What is the return value of splice
// it returns only an empty array

//Q3. Update mar to March
// const indexOfUpdate = months.indexOf("mar")
// months.splice(indexOfUpdate, 1, "Mar")
// console.log(months);
